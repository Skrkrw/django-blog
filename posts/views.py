...
from django.shortcuts import render, get_object_or_404, redirect # Last tow allow us to serve up URLs or return an error
...
def create_or_edit_post(request, pk=None):
    """Create a view that allow us to create or edit a post depending if the Post ID is null or not"""
