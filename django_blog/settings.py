...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'django.template.context_processors.media', # Adding a new contex_processor
            ],
        },
    },
]
...
# This is just to continue the integration testing with Travis working
# Travis will not knoiw where the DATABES URL is
if "DATABASE_URL" in os.environ:
    DATABASES = {
        'default': dj_database_url.parse(os.environ.get('DATABASE_URL')) # Remeber to set the databes URL
    }
else:
    print("Postgres URL not found. Using SQLit3 instead.")
    DATABASES = {
        'default': {
            'ENGINE': 'django.db.backends.sqlite3',
            'NAME': os.path.join(BASE_DIR, 'db.sqlite3'),
